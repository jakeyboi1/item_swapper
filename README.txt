...
It currently supports removing 1 item(as many of said item as you want), and adding as many or as little items as youd like
...
Special thanks to Outsider for teaching me how to setup a config.lua to be used in the script. Aswell as for helping me with webhooks, and cleaning up the server.lua
...
This is also the first script I have ever written from scratch, the most I have done before this was edit scripts. So please do let me know if you see things that I could improve upon!
